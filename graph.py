...
async def graph(c1, c2, c3, c4, c5, c6, c7, c8, user_id):
    ...
    labels = ['Способность использовать современные методы и технологии обучения',
              ...
              'Диагностика',
              'Способность осуществлять обучение с учётом социальных, возрастных, психофизических и индивидуальных особенностей ',
              'Цифровая грамотность',
              'Готовность к охране и безопасности ',
              'Коммуникация ',
              'Готовность к профессиональной деятельности в соответствии нормативно-правовыми актами сферы образования ']
